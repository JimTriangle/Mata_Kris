<x-layouts.app title="Ajouter un concert">
    <div class="admin-form-modern">
        <div class="form-header">
            <h1 class="form-title">Ajouter un nouveau concert</h1>
            <p class="form-subtitle">Créez une nouvelle date de concert pour votre site</p>
        </div>

        <form action="{{ route('admin.concerts.store') }}" method="POST" class="form-content">
            @csrf
