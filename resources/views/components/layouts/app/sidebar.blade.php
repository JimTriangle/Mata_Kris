<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' }" x-init="$watch('darkMode', val => localStorage.setItem('darkMode', val))" :class="darkMode ? 'dark' : 'light'">
    <head>
        <x-head />
    </head>
    <body class="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
        <aside
            x-data="{
        ...
        >
            ...
            >
                <button
                    ...
                    type="button"
                    class="w-6 h-6 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            ...
            <div class="h-16 flex items-center justify-center shrink-0 border-b border-gray-200 dark:border-gray-800">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center justify-center" :class="sidebarOpen ? 'w-12 h-12' : 'w-10 h-10'">
                    <x-app-logo-icon />
                </a>
            </div>
            ...
            <nav class="flex-1 flex flex-col overflow-y-auto">
                <div class="flex-1 space-y-1 p-3">
                    ...
                    <div x-data="{
                        menuOpen: {{ request()->routeIs(['admin.concerts.*', 'admin.photos.*']) ? 'true' : 'false' }}
                    }">
                        <button
                        ...
                        >
                            <div class="flex items-center gap-3">
                                ...
                                <span x-show="sidebarOpen" x-transition>Contenu</span>
                            </div>
                            <svg
                                x-show="sidebarOpen"
                ...
                <div class="p-3 mt-auto border-t border-gray-200 dark:border-gray-800">
                    ...
                    <button
                        ...
                        class="w-full flex items-center gap-3 p-2 mb-2 rounded-md text-sm font-medium transition-colors duration-150 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white"
                        :class="! sidebarOpen && 'justify-center'"
                    ...
                    >
                        ...
                        <span x-show="sidebarOpen" x-transition x-text="darkMode ? 'Mode clair' : 'Mode sombre'"></span>
                    </button>
                    ...
                    <div x-data="{ userMenuOpen: false }" class="relative">
                        ...
                        >
                            ...
                            >
                            <div x-show="sidebarOpen" x-transition class="flex flex-col items-start flex-1 text-left">
